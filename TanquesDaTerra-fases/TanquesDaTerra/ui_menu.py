...
def mostrar_pagina_inicial(screen):
    ...
    pagina_img = pygame.transform.scale(pagina_img, (800, 600))
...
def mostrar_pagina_init(screen):
    ...
    while True:
        for e in pygame.event.get():
            ...
            if e.type == pygame.MOUSEBUTTONDOWN and e.button == 1:
                ...
                if btn_ranking.collidepoint(e.pos):
                    return  # Troque para a função desejada
        ...
        # Para depuração, desenhe as áreas dos botões:
        # pygame.draw.rect(screen, (0,255,0), btn_escolher, 2)
        # pygame.draw.rect(screen, (255,255,0), btn_ranking, 2)
        # pygame.draw.rect(screen, (255,0,0), btn_sair, 2)
        pygame.display.flip()
        clock.tick(60)